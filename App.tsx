...
const Hero = () => {
  ...
  return (
    <section id="hero" className="w-full h-screen bg-[url('./img/hero-bg.jpg')] bg-cover bg-[-75%_0px] md:bg-center relative flex flex-col justify-center text-white px-4 md:pl-[350px]">
